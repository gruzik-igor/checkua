    ...
    public function index()
    {
        ...
        if($this->data->uri(2) != ''){
            ...
            if($mailTemplate) {
                ...
                $fields = $this->db->getQuery("SELECT ff.name FROM `wl_mail_active` as ma LEFT JOIN `wl_forms` as f ON ma.form = f.id LEFT JOIN `wl_fields` as ff ON f.id = ff.form WHERE ma.template = $mailTemplate->id");
            ...
            $mailTemplates = $this->db->getAllData('wl_mail_templates');
