...
class install{
	...
	public $name = "forum";
	public $title = "Форум статей";
	public $description = "Форум статей із підтримкою категорій. Мультимовна.";
	public $group = "page";
	public $table_service = "s_forum";
	public $table_alias = "";
	...
	public $options = array('useGroups' => 1, 'ArticleMultiGroup' => 0, 'resize' => 1, 'folder' => 'forum', 'idExplodeLink' => '-');
	...
	public $seo_name = "Форум статей";
	public $seo_title = "Форум статей";
