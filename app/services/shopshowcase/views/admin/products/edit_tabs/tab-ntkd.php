...
<?php } else { ?>
	...
	<label>Назва:</label> <input type="text" onChange="save('name', this)" value="<?=$ntkd->name?>"><br>
	<br>
	...
	<div id="tkd-block" class="tkd">
		<label>title:</label> <input type="text" onChange="save('title', this)" value="<?=$ntkd->title?>"><br>
		<label>keywords:</label> <input type="text" onChange="save('keywords', this)" value="<?=$ntkd->keywords?>"><br>
		<label>description:</label><br>
