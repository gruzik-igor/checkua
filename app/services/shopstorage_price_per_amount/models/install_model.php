...
class install
{
	...
	public $name = "shopstorage_price_per_amount";
	public $title = "Склад з керуванням ціною від кількості";
	public $description = "Склад з керуванням ціною від кількості";
	public $group = "shop";
	public $table_service = "s_shopstorage_ppa";
