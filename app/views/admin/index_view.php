...
<div class="row">
    ...
    <div class="col-md-4 ui-sortable">
        <div class="panel panel-inverse">
            <div class="panel-heading">
                <div class="panel-heading-btn">
                    <a href="<?=SITE_URL?>admin/liqpay" class="btn btn-xs btn-success"><i class="fa fa-repeat"></i> До всіх квитанцій</a>
                </div>
                <h4 class="panel-title">Оплати LiqPay</h4>
            </div>
            <div class="panel-body">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered nowrap" width="100%">
                        ...
                        $this->db->select('s_liqpay as p', '*', $where);
                        ...
                        if(!empty($payments)) { ?>
                            ...
                            <?php foreach($payments as $pay){ ?>
                                <tr>
                                    <td><a href="<?=SITE_URL.'admin/'.$pay->cart_alias_name.'/'.$pay->cart_id?>" class="btn btn-primary btn-xs">До замовлення</a><br><a href="<?=SITE_URL.'admin/liqpay/'.$pay->id?>" class="btn btn-info btn-xs">До оплати</a></td>
                                    <td><?=date("d.m.Y H:i", $pay->date_edit)?></td>
                                    <td><b><?=$pay->amount?> грн</b></td>
                                    <td><?=$pay->status?></td>
                                </tr>
                        <?php } } else { ?>
                            <tbody>
